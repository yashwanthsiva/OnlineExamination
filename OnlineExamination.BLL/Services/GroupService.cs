...
namespace OnlineExamination.BLL.Services
{
    public class GroupService : IGroupService
    {
        ...
        {
            return obj is GroupService service &&
                   EqualityComparer<IUnitOfWork>.Default.Equals(_unitOfWork, service._unitOfWork) &&
                   EqualityComparer<ILogger<GroupService>>.Default.Equals(_iLogger, service._iLogger);
        }
